...
L'esquema de l'entorn seria el següent:

\begin{figure}[hp]
   \centering
   \includegraphics[scale=0.4]{esquema-simple.eps}
...
al tenir el codi font podem seguir els passos que fan servir.

\begin{figure}[hp]
   \centering
   \includegraphics[scale=0.4]{esquema-intermig.eps}
...
\textit{/proc/\textless PID\textgreater/goto} aconseguiríem migrar el procés de
...
\begin{figure}[hp]
   \centering
   \includegraphics[scale=0.4]{esquema-complex.eps}
...
Hem pensat que el nostre sistema tindria un disseny a dues capes:

\begin{figure}[hp]
   \centering
   \includegraphics[scale=0.4]{esquema-arquitectura.eps}
...
partint de les necessitats generals definides en el capítol anterior.
...
`-- <IDCluster>
    ...
    `-- <IDNode>
        ...
        `-- <IDProces>
            ...
            |-- cmdline		Línia de comandes amb la que s'ha arrencat el programa
...
segons el que s'indica al capítol 3.
