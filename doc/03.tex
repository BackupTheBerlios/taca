...
(què ens ha d'oferir la capa inferior) \\
(poder migrar processos, poder veure on són, ...) \\
(què nosaltres VOLEM poder fer)
...
\section{Què ens ofereixen els sistemes}
(què proporciona a una capa superior) \\
(si ja proporciona una abstracció semblant a la que volem...) \\
(què nosaltres PODEM fer)
...
operacions
	de consulta de informació de proces (mirar següent secció)
\item Consultar resum de l'estat del node
